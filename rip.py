...
Group member:
Name: Meng Li       Student ID: mli134       Student number: 36273070
Name: Bo Li         Student ID: bli28        Student number: 62543654
...
INFINITE_METRIC = 16
PERIODIC_UPDATE_TIMER_INTERVAL = 5
...
class RIPDaemon:
    ...
    def activate_triggered_updates_timer(self):
        ...
        """
        timer = threading.Timer(random.uniform(0, 0.5 * PERIODIC_UPDATE_TIMER_INTERVAL), self.triggered_update_timer_callback)
